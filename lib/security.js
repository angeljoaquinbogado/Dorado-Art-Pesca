...
function rateSecret() {
    // Debe ser un secreto independiente. Nunca reutilizamos ni derivamos esta
    // clave desde SUPABASE_SERVICE_ROLE_KEY: si falta, el rate limit falla cerrado.
    return String(process.env.RATE_LIMIT_SECRET || "").trim();
}
